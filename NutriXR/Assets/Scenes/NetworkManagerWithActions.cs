...
public class NetworkManagerWithActions : NetworkManager
{
    ...
    public static new NetworkManagerWithActions singleton => (NetworkManagerWithActions)NetworkManager.singleton;
    ...
    {
        Debug.Log("NetworkManagerWithActions.OnStartAction invoked");
    }
